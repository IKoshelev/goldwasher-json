        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, pruneKeysAsync(data, data, testFn)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, degradePrimitiveValuesAsync(data, data, testFn)];
                case 3:
                    _a.sent();
...
function pruneKeysAsync(root, currentBranch, testFn) {
    return __awaiter(this, void 0, void 0, function () {
        var keys, _i, keys_2, key, val, res, er_1, surviverKeys, _a, surviverKeys_2, key, surviverValue;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    _b.label = 8;
                case 8:
                    if (!(_a < surviverKeys_2.length)) return [3 /*break*/, 11];
                    key = surviverKeys_2[_a];
                    surviverValue = currentBranch[key];
                    if (!lodash_1.default.isObjectLike(surviverValue)) return [3 /*break*/, 10];
                    return [4 /*yield*/, pruneKeysAsync(root, surviverValue, testFn)];
                case 9:
                    _b.sent();
                    _b.label = 10;
                case 10:
...
function degradePrimitiveValuesAsync(root, currentBranch, testFn) {
    return __awaiter(this, void 0, void 0, function () {
        var keys, _i, keys_4, key, val, typeofVal, listOfPossibleDegradations, lastPassingValue, _a, listOfPossibleDegradations_2, degradedValue, res, er_2, surviverKeys, _b, surviverKeys_4, key, surviverValue;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 10:
                    ...
                    return [4 /*yield*/, degradePrimitiveValuesAsync(root, surviverValue, testFn)];
                case 11:
                    _c.sent();
                    _c.label = 12;
                case 12:
